...
class dumpHelper{
     ...
     * @return MYSQL_DUMP
     */
    public function __construct($host = "", $user = "", $dbpwd = "") {
     ...
     * @param String: $dbpwd
     */
    public function setDBHost($host, $user, $dbpwd) {
        $this->dbhost = $host;
        $this->dbuser = $user;
        $this->dbpwd = $dbpwd;
    }
     ...
     */
    public function dumpDB($database = HAR_ALL_DB, $tables = HAR_ALL_TABLES, $options = HAR_ALL_OPTIONS) {
        $this->_connect();
